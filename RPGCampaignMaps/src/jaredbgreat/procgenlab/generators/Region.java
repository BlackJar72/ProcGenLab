...
import jaredbgreat.procgenlab.generators.region.BiomeType;
import jaredbgreat.procgenlab.generators.region.Map;
 ...
 * @author jared
 */
public class Region implements IGenerator {
    Map map;
    
    @Override
    public void generate(Long seed) {
        map = new Map(Size.setting.size, Size.setting.size);
        map.generate(new Random(seed));
    }
