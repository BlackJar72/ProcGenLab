...
/**
 * The core hash used to generated pseudo-random numbers; this is a hash of 
 * 4th dimensional coordinates (including a t for time, i.e., pseudo-iterations 
 * at that x,y,z coordinate).  This allows usable pseudo-random numbers for 
 * generation to be consistently generated for any coordinate, repeatedly, 
 * consistently, and on demand.
 * 
 * This may be overkill, but seems to give good results -- though I have found 
 * at least one case of a duplicate output on one map, so...?
 *
...
public class SpatialNoise {
     ...
     * @return 
     */
    public byte byteFor(int x, int z, int t) {
        long out = longFor(x, z, t);
        return (byte)(((out >> (((out >> 8)) & 32) + 16)) & 0xff);
    }
     ...
     * @return 
     */
    public byte bitFor(int x, int z, int t) {
        return (byte)((longFor(x, z, t) & 1));
    }
